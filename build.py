...
T={
 'ko':dict(lang='ko',other='en',otherLabel='EN',nav=[('/ko/','홈'),('/ko/heroes/','영웅'),('/ko/threats/','위협'),('/ko/arenas/','아레나'),('/ko/news/','소식'),('/ko/board/','게시판')],
   heroTitle=('무너진 서울.','마지막 파도.'),heroLead='리얼 3D 1인칭 슈터(FPS). 무너진 서울 한복판에서 끝없이 밀려오는 파도를 버텨라. 영웅 여섯, 위협 열둘, 열한 구역.',
   genre='웨이브 서바이벌 · iOS',feat=[('3D','리얼 3D','반실사 캐릭터와 무너진 서울을 Unity 실시간 3D로. 비 젖은 아스팔트에 네온이 번진다.'),('FPS','1인칭 슈팅','100 스테이지, 눈앞까지 달려드는 적. 조준하고, 쏘고, 버틴다. 3인칭 아레나 모드도 함께.'),('50','50 웨이브','웨이브마다 강해지는 적 7종과 보스 5. 매 판 다른 강화 카드로 빌드를 짠다.')],featTitle='3D FPS',featLead='손 안에서 도는 리얼 3D 1인칭 슈터.',cta='영웅 보기',cta2='인트로 보기',roster='영웅',rosterLead='여섯 명. 각자 다른 이유로 서 있다.',threats='위협',threatsLead='한 마리가 더 무섭게. 적 7, 보스 5.',
 ...
 'en':dict(lang='en',other='ko',otherLabel='KO',nav=[('/en/','Home'),('/en/heroes/','Heroes'),('/en/threats/','Threats'),('/en/arenas/','Arenas'),('/en/news/','News'),('/en/board/','Community')],
   heroTitle=('A fallen Seoul.','The last wave.'),heroLead='A real-3D first-person shooter. Hold the line in the ruins of Seoul as the waves keep coming. Six heroes, twelve threats, eleven districts.',
   genre='Wave survival · iOS',feat=[('3D','Real 3D','Semi-realistic heroes and a broken Seoul, rendered live in Unity. Neon bleeding across wet asphalt.'),('FPS','First-person','100 stages, enemies rushing right into your face. Aim, fire, hold. A third-person arena mode too.'),('50','50 waves','Seven enemy types and five bosses that grow with every wave. New upgrade cards each run.')],featTitle='3D FPS',featLead='A real-3D first-person shooter in your hand.',cta='Meet the heroes',cta2='Watch the intro',roster='Heroes',rosterLead='Six of them. Each standing for a different reason.',threats='Threats',threatsLead='Fewer, but each one worse. 7 enemies, 5 bosses.',
...
for l in ('ko','en'):
    ...
    body=f'''<section class="hero"><video class="bg" src="/assets/video/hero_loop.mp4?v=3" poster="/assets/video/hero_poster.jpg?v=3" autoplay muted loop playsinline></video><div class="shade"></div>
...
<section class="sec" id="intro"><div class="wrap"><div class="sh"><h2>INTRO</h2><p>{'2026 · 61초' if l=='ko' else '2026 · 61 s'}</p></div><video class="intro" src="/assets/video/opening.mp4?v=4" poster="/assets/video/hero_poster.jpg?v=3" controls preload="none" playsinline></video></div></section>
