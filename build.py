...
T={
 'ko':dict(lang='ko',other='en',otherLabel='EN',nav=[('/ko/','홈'),('/ko/heroes/','영웅'),('/ko/threats/','위협'),('/ko/arenas/','아레나'),('/ko/news/','소식'),('/ko/board/','게시판')],
   heroTitle=('무너진 서울.','마지막 파도.'),heroLead='리얼 3D 1인칭 슈터(FPS). 무너진 서울 한복판에서 끝없이 밀려오는 파도를 버텨라. 영웅 다섯, 위협 열둘, 열한 구역.',
 ...
 'en':dict(lang='en',other='ko',otherLabel='KO',nav=[('/en/','Home'),('/en/heroes/','Heroes'),('/en/threats/','Threats'),('/en/arenas/','Arenas'),('/en/news/','News'),('/en/board/','Community')],
   heroTitle=('A fallen Seoul.','The last wave.'),heroLead='A real-3D first-person shooter. Hold the line in the ruins of Seoul as the waves keep coming. Five heroes, twelve threats, eleven districts.',
...
<link rel="stylesheet" href="/assets/site.css?v=8">{extra_head}</head><body>
...
for l in ('ko','en'):
    ...
    body=f'''<section class="hero"><video class="bg" src="/assets/video/hero_loop.mp4?v=4" poster="/assets/video/hero_poster.jpg?v=4" autoplay muted loop playsinline></video><div class="shade"></div>
